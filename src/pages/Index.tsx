  ...
  return (
    <div className="min-h-screen bg-[#f5f7fa] px-6 py-4">
      ...
      <div className="grid grid-cols-3 gap-6 mb-6">
        ...
        <Card title="Employee Satisfactory">
          <div className="mb-4">
      ...
      <div className="grid grid-cols-4 gap-6 mb-6">
        <div className="col-span-3">
          <Card title="" showExpandIcon={false} className="overflow-visible">
            <div className="border-b border-gray-200">
              <div className="flex -mx-6 -mt-6">
                <button 
                  className={`px-6 py-4 ${selectedTab === "Attendance" ? "border-b-2 border-black font-semibold" : "text-gray-500"}`}
                  onClick={() => setSelectedTab("Attendance")}
                >
                  Attendance
                </button>
                <button 
                  className={`px-6 py-4 ${selectedTab === "Absences" ? "border-b-2 border-black font-semibold" : "text-gray-500"}`}
                  onClick={() => setSelectedTab("Absences")}
                >
                  Absences
                </button>
                <button 
                  className={`px-6 py-4 ${selectedTab === "Day-Off Request" ? "border-b-2 border-black font-semibold" : "text-gray-500"}`}
                ...
                <div className="ml-auto flex items-center pr-6">
                  <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                    <button className="px-4 py-2 border-r border-gray-200">Department</button>
                    <button className="px-4 py-2 border-r border-gray-200">Employment Type</button>
                    <button className="px-4 py-2">Status</button>
                  </div>
